    ...
    <div class="section-card">
      ...
      <div v-show="!isCollapsed" class="map-content">
        <div class="coming-soon">
          <h4>Coming Soon</h4>
          <ul>
            <li>Camp layout and space planning</li>
            <li>Tent and structure placement</li>
            <li>Infrastructure markers (kitchen, bathrooms)</li>
            <li>Neighbor coordination and boundaries</li>
            <li>Emergency exit and safety planning</li>
          </ul>
        </div>
      </div>
    </div>
